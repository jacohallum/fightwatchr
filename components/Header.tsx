...
export default function Header() {
  ...
  return (
    <header className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-red-900/30">
      {/* Main Header Row */}
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="/dashboard" className="flex items-center">
            <h1 className="text-2xl lg:text-3xl font-bold text-white whitespace-nowrap">
        ...
        <nav className="hidden lg:flex items-center justify-center absolute left-1/2 transform -translate-x-1/2 space-x-1">
          <a href="/dashboard/fighters"
            className="text-gray-300 hover:text-white px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-700/50 rounded"
          >
            FIGHTERS
          </a>
      ...
      {showMobileMenu && (
        <div className="lg:hidden bg-gray-900 border-t border-gray-700 py-3">
